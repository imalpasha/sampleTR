var PoiRadar = {
	...
	show : function initFn() {
		...
		// set the north-indicator image for the radar (not necessary if you
		// don't want to display a north-indicator)
		...
		// usually center of radar is in the exact middle of the bakground,
	...
	// you may define some custom action when user pressed radar, e.g. display
	// distance, custom filtering etc.
